<p align="center">
<picture>
    <source media="(prefers-color-scheme: dark)" srcset="img/QC-playgrounds-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="img/QC-playgrounds-light.svg">
 </picture>
<br>
 
&nbsp;

✨ If you would like to help spread the word about QC, please consider starring the repo!

> [!WARNING]
> Here be dragons! As we plan to ship a torrent of features in the following months, future updates **will** contain **breaking changes**. With QC evolving, we'll annotate changes and highlight migration paths as we encounter them.


## What is QC?
QC is a Rust library for building scalable, modular, and ergonomic **LLM-powered** applications.

More information about this crate can be found in the [official](https://docs.QC.rs) & [crate](https://docs.rs/QC-core/latest/QC/) (API Reference) documentations.

Help us improve QC by contributing to our [Feedback form](https://bit.ly/QC-Feeback-Form).

## Table of contents

- [What is QC?](#what-is-QC)
...
### Simple example:
```rust
use QC::{completion::Prompt, providers::openai};
...
You can find more examples each crate's `examples` (ie. [`QC-core/examples`](./QC-core/examples)) directory. More detailed use cases walkthroughs are regularly published on our [Dev.to Blog](https://dev.to/0thtachi) and added to QC's official documentation [(docs.QC.rs)](http://docs.QC.rs).
